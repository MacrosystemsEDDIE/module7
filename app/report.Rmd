...
41. `r substr(quest["q41", ], 5, nchar(quest["q41", ]))`
      ...
      a.  `r substr(quest["q41a", ], 3, nchar(quest["q41a", ]))` 
           ...
           *Figure 18. A series of of one-day-ahead forecasts generated using the current forecasting system and data collection method.*
...
42. `r substr(quest["q42", ], 5, nchar(quest["q42", ]))`
      ...
      a.  `r substr(quest["q42a", ], 3, nchar(quest["q42a", ]))` 
           ...
           *Figure 19. A series of of one-day-ahead forecasts generated using the borrowed high-frequency sensor.*
...
43. `r substr(quest["q43", ], 5, nchar(quest["q43", ]))`
      ...
      a.  `r substr(quest["q43a", ], 3, nchar(quest["q43a", ]))` 
           ...
           *Figure 20. A series of of one-day-ahead forecasts generated using the current forecasting system and data collection method and showing the observation for Saturday, Oct. 11.*

      b.  `r substr(quest["q43b", ], 3, nchar(quest["q43b", ]))` 

           *Please copy-paste your Q43b-plot.png image here.*

           *Figure 21. A series of of one-day-ahead forecasts generated using the borrowed high-frequency sensor and showing the observation for Saturday, Oct. 11.*
